...
- No validation that this relationship holds
...
**Issues:**
- Correctly sets `service_price`
- `price` represents different thing than fee-only bookings (service + addons vs. platform fee split)
...
- Relies on caller to provide correct values
